...
What's the difference between and SFG and SFC object?

## 2.2.6 Simple features geometries (sfg)

Here's the beginning of the answer to my previous question.

sfg represents gemoetry types: point, linestring, polygon, multi-versions, and collection.

Functions are well named, all with a prefix of "st_" followed by the geometry type you'd like to create.
